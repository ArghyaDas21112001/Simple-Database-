from tkinter import*
import backend #file nmae for backend.py
...
def search_command():
    list.delete(0,END)
    for row in backend.search(date_text.get(),earnings_text.get(),exercise_text.get(),study_text.get(),diet_text.get(),programming_text.get()):
        list.insert(END,row)

def add_command():
    backend.insert(date_text.get(),earnings_text.get(),exercise_text.get(),study_text.get(),diet_text.get(),programming_text.get())
    list.delete(0,END)
    list.insert(END,(date_text.get(),earnings_text.get(),exercise_text.get(),study_text.get(),diet_text.get(),programming_text.get()))
...
e6=Entry(win,textvariable=programming_text)
e6.grid(row=2,column=3)
##################################################
list = Listbox(win,height=8,width=40)
